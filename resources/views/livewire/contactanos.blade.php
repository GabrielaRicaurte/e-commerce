<div class="shadow-lg mx-auto mt-5 p-8 rounded-xl max-w-xl contactanos">
    ...
    <ul class="space-y-2 mb-8">
        ...
        <li>
            ...
            <a href="mailto:contacto@tiendavirtual.com" class="font-medium text-gray-600 hover:underline">contacto@tiendavirtual.com</a>
        </li>
        <li>
            <strong class="text-gray-700">WhatsApp:</strong>
            <a href="https://wa.me/521234567890" target="_blank" class="font-medium text-gray-600 hover:underline">+52 123 456 7890</a>
        </li>
    </ul>
